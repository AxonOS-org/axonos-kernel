...
/// - [`axonos_capability::Capability`] discriminants (RFC-0006 §3)
/// - [`axonos_capability::CapabilitySet`] bitfield encoding (RFC-0006 §4)
/// - [`axonos_intent::IntentObservation`] serialised form (RFC-0006 §5)
